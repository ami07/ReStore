...
import org.apache.pig.backend.hadoop.executionengine.mapReduceLayer.plans.MROperPlanRewriteUtils;
...
public class MapReduceLauncher extends Launcher{
    ...
    public PigStats launchPig(PhysicalPlan php,
        ...
        //if the restore flag is set, call the ReStore version of launchPig
        boolean isReStoreOn="true".equalsIgnoreCase(pc.getProperties().getProperty(RESTORE_ON, "false"));
        if(isReStoreOn){
        	//this.launchPigFinalize(mrp, grpName, pc);
        	return MROperPlanRewriteUtils.runReStore(mrp, this, grpName, pc);
    ...
    public PigStats launchPigFinalize(MROperPlan mrp, String grpName,
			PigContext pc) throws PlanException,
            					VisitorException,
            					IOException,
            					ExecException,
